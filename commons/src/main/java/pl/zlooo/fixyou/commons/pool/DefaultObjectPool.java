...
/**
 * Totally <B>NOT THREAD SAFE</B> object pool tailored for {@link pl.zlooo.fixyou.parser.model.FixMessage} use case. Basic idea is that we do not need any kind of synchronization/thread safety(netty events in single fix session are
