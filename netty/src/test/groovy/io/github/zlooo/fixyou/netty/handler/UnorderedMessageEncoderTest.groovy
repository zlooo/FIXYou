...
class UnorderedMessageEncoderTest extends Specification {

    private UnorderedMessageEncoder messageEncoder = new UnorderedMessageEncoder()
    @Shared
    ...
    def "should encode simple message"() {
        ...
        Assertions.
                assertThat(buf.toString(StandardCharsets.US_ASCII).split("\u0001")).
                containsExactlyInAnyOrderElementsOf(expectedTags("49=sender\u000156=target\u000152=20210916-07:25:44.694\u000145=666\u0001123=Y\u000158=test\u00015001=1.23\u00015002=1\u0001"))
    }
    ...
    def "should encode message containing repeating group"() {
        ...
        Assertions.
                assertThat(buf.toString(StandardCharsets.US_ASCII).split("\u0001")).
                containsExactlyInAnyOrderElementsOf(expectedTags("49=sender\u000156=target\u000158=test\u0001453=2\u0001448=partyID1\u0001448=partyID2\u0001"))
    }
    ...
    def "should encode message containing nested repeating group"() {
        ...
        Assertions.
                assertThat(buf.toString(StandardCharsets.US_ASCII).split("\u0001")).
                containsExactlyInAnyOrderElementsOf(expectedTags("49=sender\u000156=target\u000158=test\u000185=2\u0001787=C\u0001781=2\u0001782=ID1\u0001782=ID2\u0001787=D\u0001781=2\u0001782=ID3\u0001782=ID4\u0001"))
    }

    Iterable<String> expectedTags(String body) {
        ...
        return fixMessage.split("\u0001").toList()
    }
}
