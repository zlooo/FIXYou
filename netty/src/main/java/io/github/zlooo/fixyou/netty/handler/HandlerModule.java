...
public interface HandlerModule {
    ...
    static ChannelHandler provideAfterSessionHandlerMessageValidatorHandler(Clock clock, @Named("fixMessageObjectPool") ObjectPool fixMessageObjectPool) {
    ...
    static ChannelHandler provideBeforeSessionHandlerMessageValidatorHandler(@Named("fixMessageObjectPool") ObjectPool fixMessageObjectPool) {
