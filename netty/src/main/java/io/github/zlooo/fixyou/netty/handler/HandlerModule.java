...
public interface HandlerModule {
    ...
    static ChannelHandler provideAfterSessionHandlerMessageValidatorHandler(Clock clock, @Named("fixMessageObjectPool") ObjectPool<? extends AbstractPoolableFixMessage> fixMessageObjectPool) {
    ...
    static ChannelHandler provideBeforeSessionHandlerMessageValidatorHandler(@Named("fixMessageObjectPool") ObjectPool<? extends AbstractPoolableFixMessage> fixMessageObjectPool) {
