...
class InitiatorSessionInitializationIntegrationTest extends Specification {
    ...
    private quickfix.SessionID sessionID = new quickfix.SessionID("FIXT.1.1", targetCompId, senderCompId)
    ...
    void setup() {
        ...
        engine = FIXYouNetty.
                ...
                registerSessionAndDictionary(new SessionID("FIXT.1.1".toCharArray(), senderCompId.toCharArray(), targetCompId.toCharArray()), "dictionaryId", TestSpec.INSTANCE,
